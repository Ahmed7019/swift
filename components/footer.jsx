    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8 border-t border-gray-800">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            >
              ...
              <p className="text-gray-400 mb-4">
                نقدم حلولًا تسويقية مبتكرة تساعد العلامات التجارية على النمو والتطور في العصر الرقمي
              </p>
              <div className="flex space-x-4 space-x-reverse">
                <a
                  href="#"
                  className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:bg-emerald-900/30 hover:text-emerald-400 transition-colors"
                >
          ...
          <div>
            ...
            >
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="#achievements" className="text-gray-400 hover:text-emerald-400 transition-colors">
                    إنجازاتنا
                  </Link>
                </li>
                <li>
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-gray-500 text-center">&copy; {currentYear} سويفت. جميع الحقوق محفوظة.</p>
          <p className="text-gray-600 text-center text-sm mt-2">
            <span className="text-gray-500">Swift Digital Marketing</span> | Cairo, Egypt
          </p>
        </div>
      </div>
    </footer>
